...
//========================= cpanel for users ==================================================================
    ...
    public function get_user_collage($id)
    {
   ...
   /* public function check_username_exist($username = '')
    ...
    public function getuserwhere($colid,$depid){
        $this->db->where('COL_NO',$colid);
        $this->db->where('DEP_NO',$depid);
        return $this->db->get('EMP_VIEW')->result();
    }

    public function get_usr_dep($colid,$depid){
