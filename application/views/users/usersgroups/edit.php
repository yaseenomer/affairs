    ...
    <div class="page-content">
        <div class="page-header">
            <div class="header-title">
                <span class="h-main">  تعديل مجموعة     </span>
                <span class="h-sub">
                </span>
            </div>
                ...
                <div class="portlet light">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <form action="<?=base_url('users/usersgroups/update')?>" method="post">
                                ...
                                <div class="form-group row <?=form_error('id')? ' has-error': ''?>">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control"  name="id"  value="<?= $group->GROUP_ID ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" id="location"  name="desc"  value="<?= $group->GROUP_DESC ?>">
                                    </div>
                                </div>
