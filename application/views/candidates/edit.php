            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="portlet light bordered">
                    <div class="portlet-body form">
                        <form action="<?=base_url('affirs/Candidates/update')?>" method="post" role="form" >
                            <div class="form-body">
                                <input type="hidden" value="<?=$cande->COUR_ID?>" name="old_course_id">
                                    ...
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <select name="COUR_ID"  class="form-control"  style="width:100%">
                                                <option value="<?=$cande->COUR_ID?>"><?=$cande->PROG_ARAB_NAME?> </option>
                                    ...
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="form-group">
                                            ...
                                            <select name="EMP_NO"  class="form-control"  style="width:100%">
                                                <option value="<?=$cande->EMP_NO?>"><?php echo iconv('windows-1256','utf-8',$cande->EMP_NAME)?> </option>                                                <?php foreach ($emps as $emp) { ?>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="form-group <?=form_error('REL_PHONE')? ' has-error': ''?>">
                                            ...
                                            <input name="REL_PHONE" type="text" class="form-control"  value="<?=$cande->REL_PHONE?>">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="form-group <?=form_error('E_MAIL')? ' has-error': ''?>">
                                            ...
                                            <input name="E_MAIL" type="text" class="form-control"  value="<?=$cande->E_MAIL?>">
