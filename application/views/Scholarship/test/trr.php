...
<div id="schol">
    ...
    <div class="modal fade" id="phone" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <div class="modal-title font-green" style="font-size: 20px">تعديل رقم الهاتف</div>
                </div>
                <form action="<?= base_url('affirs/Scholarship/updatePhone') ?>" method="post">
                    <div class="modal-body">
                        <input type="text" class="form-control" name="phone" value="<?= $emp->REL_PHONE ?>">
                        <input type="hidden" name="emp" value="<?= $all->EMP_NO ?>">
                        <input type="hidden" name="schol" value="<?= $all->SCHOLAR_ID ?>">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn default" data-dismiss="modal"><span
                                class="md-click-circle md-click-animate"
                                style="height: 65px; width: 65px; top: -20.5px; left: -0.65625px;"></span>إغلاق
                        </button>
    ...
    <div class="modal fade" id="email" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <div class="modal-title font-green" style="font-size: 20px">تعديل البريد الإلكتروني
                    </div>
                </div>
                <form action="<?= base_url('affirs/Scholarship/updateEmail') ?>" method="post">
                    <div class="modal-body">
