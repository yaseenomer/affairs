                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="UNIVERSITY_TARGET" class="form-control"
                                    ...
                                    <?php foreach ($universities as $university) { ?>
                                        <option value="<?php echo $university->UNV_ID?>"><?php echo $university->UNV_ARAB_NAME?></option>
                                    <?php } ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title main_color"> إضافة تخصص </div>
            </div>
            <div class="modal-body">

                <form action="<?php echo base_url('affirs/Scholarshiptools/addSpecialties') ?>"
                      method="post">
