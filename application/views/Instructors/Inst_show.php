        ...
        if(!empty($d))
        {
            foreach($d as $row)
            {
                ...
                <tr  class="table-secondary">
                    ...
                    <td ><a href="<?php echo base_url();?>Instructors_con/show/<?php echo  $row->INS_ID; ?>"   class="fa fa-info text-primary"> </a></td>
					<td ><a  href="<?=base_url('uploads/71.pdf')?> "   class="fa fa-file-word-o text-primary"> </a></td>
                    <td ><a href="<?php echo base_url();?>Instructors_con/fetch_edit/<?php echo  $row->INS_ID; ?>" class="fa fa-edit text-primary">  </a></td>
                    <td ><a href="<?php echo base_url();?>Instructors_con/del/<?php echo  $row->INS_ID; ?>" class="fa fa-trash-o text-danger" onclick="javascript:return confirm('هل تريد حذف البند ')"></a></td>
                    </tr>
                <?php
            }
        }
