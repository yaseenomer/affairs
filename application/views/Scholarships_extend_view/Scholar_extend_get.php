...
<div class="page-content">
    <div class="page-header">
        <div class="header-title">
            ...
            <span class="h-sub"> اضافة تمديد للمبتعث </span>
        </div>        
    </div>
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="portlet-body form">
                <form action="<?= base_url()?>Scholarships_ext_con/getScholar" method="post" role="form" >
                    <div class="form-body">
					<div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <a href="<?=base_url();?>Scholarships_ext_con" class="btn btn-default"> رجوع </a>
                            </div>
                        </div>
                    </div>
                    </div>
